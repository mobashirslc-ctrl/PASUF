...
const Card = ({ name, description }: { name: string, description: string }) => {
  ...
  const handleTransaction = () => {
     alert(`${name} এর জন্য ট্রানজেকশন প্রসেস শুরু হচ্ছে...`);
  };
  ...
  return (
    <div className="border border-gray-200 rounded-xl p-6 shadow-sm hover:shadow-lg transition-shadow bg-white">
      ...
      <button 
        ...
        className="w-full bg-[#0F6B4A] text-white py-2 rounded font-semibold hover:bg-green-800 transition">
        দান করুন
      </button>
    </div>
  );
...
export const DonatePage = () => {
  const funds = [
    ...
    { name: "সাধারণ বাৎসরিক অনুদান", desc: "প্রতিষ্ঠানের নিয়মিত কার্যক্রম পরিচালনায় সহায়তা।" },
    { name: "ওয়াজিব যাকাত ফান্ড", desc: "শরীয়ত মোতাবেক যাকাত আদায় ও বণ্টন করা হয়।" },
    { name: "কারিগরি ও দক্ষতা উন্নয়ন", desc: "বেকার যুবকদের দক্ষ করে গড়ে তোলার প্রকল্প।" },
    { name: "সদকায়ে জারিয়া কার্যক্রম", desc: "সদকায়ে জারিয়ার মাধ্যমে স্থায়ী কল্যাণ প্রকল্প।" },
    { name: "সমন্বিত উন্নয়ন তহবিল", desc: "সামাজিক উন্নয়নের সমন্বিত উদ্যোগ।" },
    { name: "মেধাবী সহায়তা প্রকল্প", desc: "মেধাবী শিক্ষার্থীদের শিক্ষাবৃত্তি প্রদান।" },
    { name: "মানবসেবা স্বাস্থ্য প্রকল্প", desc: "অসহায় রোগীদের জন্য উন্নত চিকিৎসা সেবা।" },
    { name: "আত্মকর্মসংস্থান ও উদ্যোক্তা", desc: "উদ্যোক্তা তৈরিতে সহজ শর্তে সহায়তা।" },
    ...
    { name: "দুর্যোগকালীন মানবিক সহায়তা", desc: "দুর্যোগে ক্ষতিগ্রস্তদের ত্রাণ সহায়তা প্রদান।" },
  ];
